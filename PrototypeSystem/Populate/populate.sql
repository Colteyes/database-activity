...
INSERT INTO sis_scheduled_course VALUES (10006, 'WINT2026', 'CPSC301', 'A');
INSERT INTO sis_scheduled_course VALUES (10007, 'WINT2026', 'CPSC302', 'A');
INSERT INTO sis_scheduled_course VALUES (10008, 'WINT2026', 'CPSC303', 'A');
INSERT INTO sis_scheduled_course VALUES (10009, 'WINT2026', 'CPSC304', 'A');
...
INSERT INTO sis_instructor_course VALUES (10006, 'WINT2026', 1);
INSERT INTO sis_instructor_course VALUES (10007, 'WINT2026', 4);
INSERT INTO sis_instructor_course VALUES (10008, 'WINT2026', 5);
INSERT INTO sis_instructor_course VALUES (10009, 'WINT2026', 3);
...
INSERT INTO sis_student_course_record VALUES (10009, 'WINT2026', 5, 2, 'CPSC304', 'B');

-- extra
INSERT INTO sis_student_course_record VALUES (10007, 'WINT2026', 1, 3, 'CPSC302', 'A');
INSERT INTO sis_student_course_record VALUES (10008, 'WINT2026', 2, 1, 'CPSC303', 'B');
INSERT INTO sis_student_course_record VALUES (10006, 'WINT2026', 3, 2, 'CPSC301', 'A');
...
--making sure the data is being displayed and put into the spool file. (Ioanne)
SET LINESIZE 200;
SET PAGESIZE 50;
COLUMN firstname FORMAT A9;
COLUMN lastname FORMAT A9;
COLUMN status FORMAT A6;
COLUMN status_date FORMAT A11;
...
COLUMN postal_code FORMAT A6;
COLUMN phonenumber FORMAT A12;
COLUMN email FORMAT A17;
SELECT * FROM sis_instructor;

COLUMN school_name FORMAT A11;
COLUMN name FORMAT A20;
COLUMN type FORMAT A4;
SELECT * FROM sis_Credential;

COLUMN course_code FORMAT A9;
COLUMN course_name FORMAT A30;
COLUMN num_of_credits FORMAT 99.9;
COLUMN prereq_course_code FORMAT A8;
SELECT * FROM sis_course;

COLUMN section_code FORMAT A12;
SELECT * FROM sis_scheduled_course;

SELECT * FROM sis_instructor_course;

COLUMN type_flag FORMAT A4;
SELECT * FROM sis_courses_within_cred;

COLUMN completion_date FORMAT A15;
SELECT * FROM sis_student_credential;

COLUMN letter_grade FORMAT A12;
SELECT * FROM sis_student_course_record;
